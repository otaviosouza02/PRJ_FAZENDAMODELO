...
\caption{Organização dos diretórios}\label{fig:unnamed-chunk-6}
\end{figure}
\newpage
3
...
5. Download dos dados i. Ao todo foram baixadas 6 nuvens de pontos
LiDAR, que antes do processamento encontravam-se da seguinte maneira:
...
\caption{Nuvens de pontos LiDAR pré-processadas}\label{fig:unnamed-chunk-7}
\end{figure}
\newpage
6
...
\caption{Dados contidos nas parcelas inventariadas}\label{fig:unnamed-chunk-8}
\end{figure}
\newpage
8
...
\caption{Comparativo entre as nuvens de pontos antes e após a clipagem}\label{fig:unnamed-chunk-9}
\end{figure}
\newpage
9
...
\caption{Processamento e resultado da classificação de solo das nuvens LiDAR}\label{fig:unnamed-chunk-10}
\end{figure}
\newpage
10
...
{\centering \includegraphics[width=0.5\linewidth]{IMAGES/nuvensnormalizadas} 

}

\caption{Resultado da normalização das nuvens}\label{fig:unnamed-chunk-11}
\end{figure}
\newpage
11

. Recorte da nuvem em tiles 300x300m (colocar a janela do plot do R)
...
\caption{Retile da nuvem em quadrados de 300x300m}\label{fig:unnamed-chunk-12}
\end{figure}
\newpage
12
...
\caption{Cálculo das métricas para cada voxel}\label{fig:unnamed-chunk-13}
\end{figure}
\newpage
13
...
\caption{Tabela com as métricas escolhidas}\label{fig:unnamed-chunk-14}
\end{figure}
\newpage
14
...
\caption{Resultado da análise de correlação}\label{fig:unnamed-chunk-15}
\end{figure}
\newpage
15
...
\caption{nao sei}\label{fig:unnamed-chunk-16}
\end{figure}
\newpage
16

. Criação de mapas raster e gráficos \newpage \# Fluxograma e etapas
Tripla amostragem
