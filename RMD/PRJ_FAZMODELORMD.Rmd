...
FORMULAS DO CALCULO DAS VARIANCIAS EM CADA TIPO DE FASE 2 ESTÃO NA PG 304
...
``` {r, echo=FALSE, fig.cap='Estimador de regressão para VTCC', fig.align='center', out.width = "60%"}
knitr::include_graphics("IMAGES/eq-estimador-regressao.png")
```

- A amostragem dupla ganha maior precisão pela adoção dos estimadores de razão e regressão e para isso a média ou o total populacional da variável auxiliar deve ser conhecido e sem erro amostral. 
