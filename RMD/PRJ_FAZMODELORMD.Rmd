...
```
\newpage
8. Clipagem da nuvem para eliminação de dados indesejados (mostrar nuvem antes e depois)  
...
``` {r, echo=FALSE, fig.cap='Resultado da normalização das nuvens', fig.align='center', out.width = "50%"}
knitr::include_graphics("IMAGES/nuvensnormalizadas.png")
```
\newpage
11. Recorte da nuvem em tiles 300x300m (colocar a janela do plot do R)
...
```
\newpage
12. Cálculo de métricas para cada voxel (explicar voxel)
...
```
\newpage
14. Análise da correlação por meio de gráfico (falar do gráfico)
